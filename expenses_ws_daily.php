      ...
      <div class="row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-4" style="text-align: right;">
              <form id="select-date-water-ex">
                <strong>Daily Expenses:</strong>
                <input type="date" id="ed" class="btn btn-default btn-sm" value="<?php if(isset($_GET['dailyDate'])) { echo $_GET['dailyDate']; } else { echo date("Y-m-d"); } ?>">
              </form>
            </div>
          </div>
          <!-- All Items -->
