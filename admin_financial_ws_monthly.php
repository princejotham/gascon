      ...
      <div class="row">
        <div class="col-sm-12">
            <div class="row" style="padding-top: 1em;padding-bottom: 1em;">
              <div class="col-sm-6">
                <button class="btn btn-success btn-sm" id="sale-report_wsm">PRINT SALES
                    <span class="fa fa-print" aria-hidden="true"></span>
                </button>
                <a href="admin_financial_ws.php" class="btn btn-primary btn-sm">Daily Sales</a>
                <a href="admin_financial_ws_monthly.php" class="btn btn-primary btn-sm active">Monthly Sales</a>
                <a href="admin_financial_ws_yearly.php" class="btn btn-primary btn-sm">Yearly Sales</a>
              </div>
              <div class="col-sm-6" style="text-align: right;">
                <form action="admin_financial_ws_monthly.php" method="GET">
                  <div class="row">
                    <div class="col-sm-4">
