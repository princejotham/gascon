    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-12">
              ...
              <div class="col-sm-6">
                <button class="btn btn-success btn-sm" id="sale-reporty">PRINT SALES
                ...
                <a href="admin_financial_pharmacy_yearly.php" class="btn btn-primary btn-sm active">Yearly Sales</a>
              </div>
              <div class="col-sm-6" style="text-align: right;">
                <form action="admin_financial_pharmacy_yearly.php" method="GET">
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                     <input type="submit" name="btn_year" class="btn btn-warning btn-sm" value="Select">
                    </div>
